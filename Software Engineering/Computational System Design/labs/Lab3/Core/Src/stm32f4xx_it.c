...
void USART6_IRQHandler(void)
{
  ...
  if (__HAL_UART_GET_FLAG(&huart6, UART_FLAG_RXNE) && __HAL_UART_GET_IT_SOURCE(&huart6, UART_IT_RXNE)) {
	HAL_UART_IRQHandler(&huart6);
  }

  if (__HAL_UART_GET_FLAG(&huart6, UART_FLAG_TXE) && __HAL_UART_GET_IT_SOURCE(&huart6, UART_IT_TXE)) {
