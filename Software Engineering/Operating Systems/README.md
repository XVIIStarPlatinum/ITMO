...
# Я использую ~~арчлинукс~~ CachyOS кст

> <p align="center">
>     <img src="/img/memes/motherboard.jpg" alt="motherboard" width="500"/>
> </p>
...
> (Авторское прим. AUR --- редкостное говнище)
...
> <h3 align="center">
>     вот он<br>
>     <img src="/img/pics/photo_2024-11-04_20-06-15.jpg" alt="big klim" width="500"/>
> </h3>

> [!IMPORTANT]
> В целях повышения оценки я решил сдать предмет на реструктуризацию.
> Подробнее [здесь](https://student.itmo.ru/ru/relearning/). (И как вы видите, я лох и не смог)

**Лектор**: [Клименков Сергей Викторович](https://my.itmo.ru/persons/106026) ([@serge-klimenkov](https://github.com/Serge-Klimenkov))

~~**Практик
**: [Осипов Святослав Владимирович](https://my.itmo.ru/persons/224794) ([@Stoorx](https://github.com/Stoorx))~~
**Практик**: [Смирнов Виктор Игоревич](https://my.itmo.ru/persons/335158) ([@vityaman](https://github.com/vityaman))

> [!TIP]
> В этом предмете есть отдельные треки (для 3, 4 и 5). Я выбрал продвинутый трек, где работал с ОС xv6, а также с
> виртуальной файловой системой.

> [!NOTE]
> Если вы выбрали продвинутый трек, то обычно стоит сдавать лабораторную работу №4.1 (файловая система). ЛР №4.2
...
- V(II) семестр: **3E** (${\color{red}60}$/100 баллов)
---
